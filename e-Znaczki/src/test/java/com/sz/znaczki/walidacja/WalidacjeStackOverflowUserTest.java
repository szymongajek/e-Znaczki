...
import com.sz.znaczki.testUtils.MockRestTemplateProvider;
...
public class WalidacjeStackOverflowUserTest {
	...
	public void walidacjaSprawdzaProgReputacji() throws IOException {
		...
		StackOverflowUserWalidator walidator10 = new StackOverflowUserWalidator(template, 10);

		assertThat(walidator10.waliduj("3307553")).isTrue();
		assertThat(walidator10.waliduj("4117496")).isTrue();

		StackOverflowUserWalidator walidator25 = new StackOverflowUserWalidator(template, 25);

		assertThat(walidator25.waliduj("3307553")).isTrue();
		assertThat(walidator25.waliduj("4117496")).isTrue();

		StackOverflowUserWalidator walidator200 = new StackOverflowUserWalidator(template, 200);

		assertThat(walidator200.waliduj("3307553")).isFalse();
		assertThat(walidator200.waliduj("4117496")).isTrue();

		StackOverflowUserWalidator walidator1000 = new StackOverflowUserWalidator(template, 1000);
