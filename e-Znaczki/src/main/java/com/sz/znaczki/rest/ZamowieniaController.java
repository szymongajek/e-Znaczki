...
public class ZamowieniaController {
	...
	@RequestMapping(value = "/nowe", method = RequestMethod.POST, params = { "imie", "nazwisko", "mail",
			"stackOverflowUID", "krajowe", "zagraniczne" })
	public ResponseEntity<?> nowe(@RequestParam("imie") String imie, @RequestParam("nazwisko") String nazwisko,
			@RequestParam("mail") String mail, @RequestParam("stackOverflowUID") String stackOverflowUID,
			@RequestParam("krajowe") int krajowe, @RequestParam("zagraniczne") int zagraniczne) {

		LOGGER.info("nowe zamowienie start: " + "imie=" + imie + " nazwisko=" + nazwisko + " mail=" + mail
				+ " stackOverflowUID=" + stackOverflowUID + " krajowe=" + krajowe + " zagraniczne=" + zagraniczne);
		try {
			Zamowienie nowe = znaczkiFasada.stworzZamowienie(imie, nazwisko, mail, stackOverflowUID, krajowe,
					zagraniczne);
	...
	public List<Zamowienie> wszystkie() {
		...
		return znaczkiFasada.wszystkieZamowienia();

	}

	@RequestMapping(value = "/wszystkieKienta", method = RequestMethod.GET, params = { "imie", "nazwisko", "mail" })
	public List<Zamowienie> wszystkieKienta(@RequestParam("imie") String imie,
		...
		return znaczkiFasada.wszystkieZamowieniaKienta(imie, nazwisko, mail);
